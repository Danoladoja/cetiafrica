      ...
      <section className="relative w-full h-[100dvh] overflow-hidden">
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-center px-8 md:px-14">
          <motion.h1
            ...
            className="font-serif text-[clamp(4rem,13.5vw,194px)] leading-[0.86] text-white tracking-tight"
          >
          ...
          <motion.p
            ...
            className="mt-4 font-sans text-xl md:text-2xl text-white/40 font-light tracking-wide"
          >
